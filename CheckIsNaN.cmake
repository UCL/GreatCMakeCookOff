...
if(CXX_HAS_STD_ISNAN)
  set(ISNAN_VARIATION "#include <cmath>\n#define not_a_number(X) std::isnan(X)\n")
elseif(CXX_HAS_ISNAN)
  set(ISNAN_VARIATION "#include <math.h>\n#define not_a_number(X) ::isnan(X)\n")
elseif(CXX_HAS___ISNAN)
  set(ISNAN_VARIATION "#include <math.h>\\n"
                      "#define not_a_number(X) __isnan(X)\\n")
elseif(CXX_HAS_FLOAT_H_ISNAN)
  set(ISNAN_VARIATION "#include <float.h>\n#define not_a_number(X) _isnan(X)\n")
else()
